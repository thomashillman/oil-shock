...
- Separate planning from execution in your own notes, commit message, or handoff.
...
- If something should guide future Claude sessions, keep it in the repo, not only in chat.
